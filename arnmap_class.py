...
class arnmap:
	...
	def scan(self, arn):
		...
		try:
			...
			if hasattr(arnmap_module, method_name) and callable(getattr(arnmap_module, method_name)):
				
				resource_scan = getattr(arnmap_module, method_name)(arn, arn_list)
